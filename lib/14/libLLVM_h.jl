...
function LLVMInitializeiVETargetInfo()
    ccall((:LLVMInitializeVETargetInfo, libllvm), Cvoid, ())
end
...
function LLVMInitializeVETarget()
    ccall((:LLVMInitializeVETarget, libllvm), Cvoid, ())
end
...
function LLVMInitializeVETargetMC()
    ccall((:LLVMInitializeVETargetMC, libllvm), Cvoid, ())
end
...
function LLVMInitializeVEAsmPrinter()
    ccall((:LLVMInitializeVEAsmPrinter, libllvm), Cvoid, ())
end
...
function LLVMInitializeVEAsmParser()
    ccall((:LLVMInitializeVEAsmParser, libllvm), Cvoid, ())
end
...
function LLVMInitializeVEDisassembler()
    ccall((:LLVMInitializeVEDisassembler, libllvm), Cvoid, ())
end
...
const LLVM_VERSION_STRING = "14.0.0jl"
